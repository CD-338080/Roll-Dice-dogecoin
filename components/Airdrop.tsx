...
export default function Airdrop() {
    ...
    const USDT_CONTRACT = 'DRGhGaTLubWAB49giectsFHMAHFaQL49oJ';
    ...
    return (
        <div className="bg-gradient-to-b from-[#F2A900] to-[#FFD166] flex justify-center min-h-screen">
            <div className="w-full text-white font-bold flex flex-col max-w-xl">
                <div className="flex-grow mt-4 bg-gradient-to-r from-[#F2A900] to-[#FFD166] rounded-t-[48px] relative top-glow z-0">
                    <div className="mt-[2px] bg-gradient-to-b from-[#FFF8E1] to-[#FFD166] rounded-t-[46px] h-full overflow-y-auto no-scrollbar">
                        <div className="px-4 pt-1 pb-24">
                            <div className="relative mt-4">
                                <div className="flex justify-center mb-4">
                                    <div className="relative">
                                        <IceCube className="w-24 h-24 rounded-lg mr-2 text-[#F2A900]" />
                                        <div className="absolute inset-0 bg-[#F2A900]/20 rounded-lg animate-pulse-slow"></div>
                                    </div>
                                </div>
                                <h1 className="text-2xl text-center mb-4 text-[#F2A900] font-extrabold tracking-wide">DOGECOIN TASKS</h1>
                                <p className="text-[#CB8D00] text-center mb-4 font-normal">Complete the tasks below to qualify for the Dogecoin Airdrop.</p>
                                ...
                                <div className="flex justify-center mb-6">
                                    <button
                                        ...
                                        className={`bg-gradient-to-r from-[#F2A900] to-[#FFD166] text-[#CB8D00] px-8 py-3 rounded-xl font-extrabold shadow-lg 
                                        transition-all duration-300 flex items-center justify-center space-x-3 w-full max-w-md 
                                        border-2 border-[#CB8D00] relative overflow-hidden
                                        ${isHoveringWithdraw ? 'scale-102' : ''}
                                        ${pulseEffect ? 'animate-pulse' : ''}
                                        ${pointsBalance < MINIMUM_WITHDRAW ? 'opacity-50 cursor-not-allowed' : ''}`}
                                        style={{
                                            boxShadow: isHoveringWithdraw ? '0 0 15px rgba(242, 169, 0, 0.5)' : '0 0 8px rgba(242, 169, 0, 0.2)'
                                        }}
                                    >
                                        ...
                                        <span className="text-lg">WITHDRAW DOGE</span>
                                    </button>
                                </div>
                                ...
                                <div className="flex justify-center mb-6">
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-gradient-to-r from-[#F2A900] to-[#FFD166] rounded-xl blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300"></div>
                                        <div className="relative bg-gradient-to-r from-[#F2A900] to-[#FFD166] text-[#CB8D00] px-8 py-4 rounded-xl font-extrabold shadow-lg 
                                            transition-all duration-300 flex items-center justify-center space-x-3
                                            border-2 border-[#CB8D00] hover:scale-105 hover:shadow-xl">
                                ...
                                <div className="bg-[#F2A900]/20 rounded-lg p-5 mb-6 border border-[#F2A900]/20 hover:border-[#CB8D00]/40 transition-all duration-300 shadow-lg">
                                    <h2 className="text-xl mb-3 text-[#CB8D00] font-extrabold">How to Earn DOGE</h2>
                                    <ul className="space-y-3 text-[#CB8D00] font-normal">
                                        <li className="flex items-start hover:translate-x-1 transition-transform duration-200">
                                            <span className="text-[#F2A900] mr-2">•</span>
                                            <span>Complete all tasks to qualify for withdrawal.</span>
                                        </li>
                                        <li className="flex items-start hover:translate-x-1 transition-transform duration-200">
                                            <span className="text-[#F2A900] mr-2">•</span>
                                            <span>Earn at least {MINIMUM_WITHDRAW} DOGE through tasks and invites.</span>
                                        </li>
                                        <li className="flex items-start hover:translate-x-1 transition-transform duration-200">
                                            <span className="text-[#F2A900] mr-2">•</span>
                                            <span>Invite friends to earn 25 DOGE per referral.</span>
                                        </li>
                                        <li className="flex items-start hover:translate-x-1 transition-transform duration-200">
                                            <span className="text-[#F2A900] mr-2">•</span>
                                ...
                                <h2 className="text-base mt-8 mb-4 text-[#CB8D00] font-extrabold tracking-wide">Your Progress</h2>
                                <div className="bg-[#F2A900]/20 rounded-lg p-4 mb-6 border border-[#F2A900]/20 hover:border-[#CB8D00]/40 transition-all duration-300 shadow-lg">
                                    <div className="flex justify-between items-center mb-2">
                                        <span className="text-[#CB8D00]">DOGE Balance:</span>
                                        <span className="text-[#F2A900] font-bold">{formatNumber(pointsBalance)} / {MINIMUM_WITHDRAW}</span>
                                    </div>
                                    <div className="w-full bg-[#F2A900]/30 rounded-full h-2.5 overflow-hidden">
                                        <div 
                                            className="bg-gradient-to-r from-[#F2A900] to-[#FFD166] h-2.5 rounded-full relative"
                                            style={{ 
