...
export default function Friends() {
  ...
  const shareText = `🐶Join me in Spin & claim dogecoin: Tap, Earn, and Win! \n Let's play and earn together!`;
            ...
            <div className="px-4 pt-1 pb-36">
              <div className="relative">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center bg-[#F2A900]/10 backdrop-blur-sm rounded-lg p-4">
                ...
                {showBonusesList && (
                  <div className="mt-4 space-y-2">
                    ...
                    {LEVELS.slice(1).map((level, index) => (
                      <div key={index} className="flex items-center bg-[#F2A900]/10 backdrop-blur-sm rounded-lg p-4">
                        <div className="flex items-center flex-1">
                  ...
                  <div className="mt-4 space-y-2">
                    {isLoadingReferrals ? (
                      ...
                      <div className="space-y-2 animate-pulse">
                        {[...Array(3)].map((_, index) => (
                          <div key={index} className="flex justify-between items-center bg-[#F2A900]/10 backdrop-blur-sm rounded-lg p-4">
                      ...
                      <ul className="space-y-2">
                        {referrals.map((referral: Referral) => (
                          <li key={referral.id} className="flex justify-between items-center bg-[#F2A900]/10 backdrop-blur-sm rounded-lg p-4">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-300">{referral.levelName} • {formatNumber(referral.points)} DOGE</p>
                              </div>
                            </div>
                      ...
                      <div className="text-center text-[#CB8D00] bg-[#F2A900]/10 backdrop-blur-sm rounded-lg p-4">
                ...
                <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 w-full max-w-xl z-40 flex gap-4 px-4">
                  <button
                    className="flex-grow py-3 bg-gradient-to-r from-[#F2A900] to-[#FFD166] text-[#CB8D00] rounded-lg font-bold pulse-animation"
                    onClick={handleInviteFriend}
                  >
                    Invite friend
                  </button>
                  <button
                    className="w-12 h-12 bg-gradient-to-r from-[#F2A900] to-[#FFD166] text-[#CB8D00] rounded-lg font-bold flex items-center justify-center"
